...
deathmsg = {
    ...
    '^was pricked to death$': '님이 바늘에 찔려 사망하셨습니다.',
    ...
    '^was burnt to a crisp whilst fighting (.+)$': '님이 %s와 싸우다 불에 타 소각되셨습니다.',
    '^walked into a fire whilst fighting (.+)$': '님이 %s와 결투를 벌이다 제 발로 불에 걸어 들어가셨습니다.',
    '^was blown from a high place$': '님이 가스트가 쏜 파이어볼에 맞고 떨어지셨습니다.',
    '^was slain by (.+)$': '님이 %s에게 살해당하셨습니다',
    '^was shot by (.+)$': '님이 %s에 의해 공기를 가르며 맞아 죽으셨습니다',
    ...
    '^starved to death$': '님이 배가 고파서 사망하셨습니다.',
    ...
    '^was knocked into the void by (.+)$': '님이 %s님에 의해 자유를 찾으셨습니다.',
    '^withered away$': '님이 위더화 되셨습니다.',
}
