...
deathmsg = {
    ...
    '^was pricked to death$': u'님이 선인장에 찔려 사망하셨습니다.',
    ...
    '^was burnt to a crisp whilst fighting (.+)$': u'님이 %s와 싸우다 불에 타 재가 되셨습니다.',
    '^walked into a fire whilst fighting (.+)$': u'님이 %s와 결투를 벌이다 제 발로 불에 걸어 들어가셨습니다.',
    '^was blown from a high place$': u'님이 가스트가 쏜 파이어볼에 맞아 높은 곳에서 떨어지셨습니다.',
    '^was slain by (.+)$': u'님이 %s에게 살해당하셨습니다',
    '^was shot by (.+)$': u'님이 %s가 공기를 가르며 쏜 무언가에 의해 맞아 죽으셨습니다',
    ...
    '^starved to death$': u'님이 굶어 죽으셨습니다..',
    ...
    '^was knocked into the void by (.+)$': u'님이 %s님에 의해 이 세계를 탈출하셨습니다.',
    '^withered away$': u'님이 위더스러워졌습니다.',
}
